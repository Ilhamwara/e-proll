...
class Employee extends CI_Controller{
    ...
    function employee_list(){        
        ...
        //$this->sidebar->set_active($groups);
    ...
    function controller_gridlist(){        
        ...
        {            
            ...
            $menu='
                  <a href="employee_edit/' . $id . '" data-toggle="tooltip" title="Edit" class="btn default btn-xs green"><i class="fa fa-edit"></i></a>
            ...
            $row = array();
            $row[]= $eRow->employee_nip;
            $row[]= $eRow->employee_name;
            $row[]= $eRow->employee_region_id;
            $row[]= $eRow->employee_divisi_id;
            $row[]= $eRow->employee_jabatan_id;
            $row[]= date("d-m-Y", strtotime($eRow->employee_start));
            $row[]= $menu;
