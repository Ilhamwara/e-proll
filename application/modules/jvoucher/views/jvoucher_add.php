...
$(document).ready(function(){  
  ...
  function addRow(ci) {      
      ...
      $('#jDetil tbody').append('<tr>'+
        ...
        '<td><input type="text" id="d_idr" name="didr[]" value="0" class="form-control input-sm" style= "text-align: right;"/></td>'+
        '<td><?php echo form_dropdownext('dregion[]', $region, "", 'id="d_region" class="form-control input-sm" required');?></td>'+
        '<td><?php echo form_dropdownext('dbranch[]', '', "", 'id="d_branch" class="form-control input-sm" required');?></td>'+
                  ...
                  <div class="portlet-body">
                    <div class="tabbable-custom ">
                      <ul class="nav nav-tabs ">
                        ...
                        <li>                          
                          <a href="#newdata" data-toggle="tab" id='tabdata'> INPUT </a>
                        </li>
                        <li>
                      ...
                      <div class="tab-content">
                        <div class="tab-pane" id="newdata">
                          <div class="portlet-body form">
                         <form action="<?php echo site_url('jvoucher/jvoucher/jvoucher_add');?>" method="post" onsubmit="return validateb4submit();"
                            id="jvoucher_save">
                            <?php
                              if(isset($result)){
                               //print_r($result);
                              ...
                              <div class="col-md-12">
                                <div style="color:red"> <?php echo validation_errors(); ?> </div>
                                  <div class="col-md-4 form-group row">
                                    <div class="col-xs-12">
                                      <label>ID</label>
                                      <label class="post checkbox-inline pull-right"><input type="checkbox" disabled><b>Posted</b></label>
                                      <label class="post checkbox-inline pull-right"><input type="checkbox" disabled><b>Disabled</b>&nbsp;</label>
                                      <label class="post checkbox-inline pull-right"><input type="checkbox" disabled><b>Reversed</b>&nbsp;</label>
                                  ...
                                  <div class="col-md-4 form-group row">
                                    <div class="col-xs-12">
                                      <label>Channel</label>
                                        <input type="text" id = "channel_id" name="channel_id" class="form-control input-sm" value="<?php echo $channel;?>" readonly>
                                    </div>
                                  </div>                     
                                  <div class="col-md-4 form-group form-group-sm row">
                                    <div class="col-xs-12">
                                    <label>Periode</label>
                                      <?php echo form_dropdown('iperiod', $period, '', 'id ="iperiod" class="form-control" style="width: 100%;" required'); ?>
                                    </div>
                                  </div>                                  
                                  <div class="col-md-4 form-group form-group-sm row">
                                    <div class="col-xs-12">
                                  ...
                                  <div class="col-md-4 form-group row">
                                    <div class="col-xs-12">
                                      ...
                                      <div class="input-group input-group-sm">
                                        <input type="text" id = "itenant" name="itenant" class="form-control input-sm" value="" required autocomplete="off">
                                        <span class="input-group-btn">
                                          <button id ="bttenant" type="button" class="btn btn-primary"><i class="fa fa-search"></i></button>
                                        </span> 
                                      <input type="hidden" id = "htenant" name="htenant" value="">
                                      </div>
                                    </div>
                                  </div>   
                                  <div class="col-md-4 form-group row">
                                  ...
                                  <br>
                                    ...
                                    <!-- /.col -->
                                <div class="col-xs-12">
                                  <br /><input type="submit" value="SUBMIT" class="btn btn-sm btn-info" />
                                </div>
                              </div>
                             </div>
                            </form>
