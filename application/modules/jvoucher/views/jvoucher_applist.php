<script>   
  ...
  $(document).ready(function(){
    ...
    var oTable=jurnalgrid("<?php echo site_url('jvoucher/jvoucherapp/controler_gridlist')?>","JTable","rtip", 33, [2,7,8], [2]); 
    ...
    $('#btnPosting').click(function() {
        ...
        $.ajax({
           url      : "<?php echo site_url('jvoucher/jvoucherapp/jvoucher_app');?>",
           type     : "POST",             
           data     : grab,
           dataType : 'json',
           success: function(e) {              
              ...
              if (e.success){                
                ...
                display_modal('Success!', 'Data #'+e.data.id+'# has been posted.');

                $('#modal-default').on('hidden.bs.modal', function () {              
                    location.href = "<?php echo site_url('jvoucher/jvoucherapp');?>";  
                }) 
              }
           },
           error: function(xhr) {              
        ...
        <div class="portlet">
          <div class="portlet-title">
            <div class="caption" align="right">
              <div class="actions">      
		            <?php echo form_open(base_url('index.php/jvoucher/jvoucherapp/controler_gridlist')); ?>
		            <div class="btn-group">
                  <a id="btnPosting" class="btn green dropdown-toggle" href="javascript:;" data-toggle="dropdown"><i class="fa fa-bookmark"></i> Posting</a>
                </div>
                <div class="btn-group">
